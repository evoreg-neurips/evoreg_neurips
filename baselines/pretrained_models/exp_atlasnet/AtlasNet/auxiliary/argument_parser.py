...
def parser():
    ...
    parser.add_argument("--dir_name", type=str, default="baselines/pretrained_models/exp_atlasnet/models")
    ...
    if opt.demo or opt.run_single_eval:
        if not exists(opt.dir_name + "/network.pth"):
            ...
            raise FileNotFoundError(f"{opt.dir_name}/network.pth Not Found. Please provide valid model path.")

        # if opt.reload_model_path == "" and opt.SVR:
        #     opt.dir_name = "./baselines/pretrained_models/exp_atlasnet/models/atlasnet_singleview_1_sphere"
        # elif opt.reload_model_path == "" and not opt.SVR:
        #     opt.dir_name = "./baselines/pretrained_models/exp_atlasnet/models/atlasnet_autoencoder_1_sphere"
