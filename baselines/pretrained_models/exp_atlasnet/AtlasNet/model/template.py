...
class SphereTemplate(Template):
    ...
    def get_regular_points(self, npoints=None, device="gpu0"):
        ...
        if not self.npoints == npoints:
            # self.mesh = pymesh.creation.icosphere(1, [0, 0, 0], 4)  # 2562 vertices
            self.mesh = pymesh.creation.icosphere(subdivisions=4, radius=1.0)  # 2562 vertices
